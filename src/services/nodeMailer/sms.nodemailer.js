                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;"><a href="#" target="_blank" style="color: #FFA73B;">${verifyLink}</a>
                            </p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;">Cheers,<br>BSTORE Team</p>
                        </td>
                    </tr>
                </table>
            </td>
...
module.exports = {
    registerAccount: (email, verifyLink) => {
        return {
            from: "BSTORE for Everyone",
            to: email,
            subject: "Verify Account",
            text: "Your text is here", // replace by html
            html: sms.register(verifyLink),
        };
    },
};
